...
# [START composer_trigger_response_onestep_dag]
import datetime
import time
...
with models.DAG(
        'composer_sample_trigger_response_onestep_dag',
    ...
    print_gcs_info >> segment_asset >> analyse_tm >> translate >> generate_output
# [END composer_trigger_response_onestep_dag]